...
也可以参考 [[06-第六章 OpenClaw Skills 技能系统|Skills 技能系统]] 来扩展更多能力。
...
除了 Edge TTS，OpenClaw 还支持 OpenAI TTS、ElevenLabs 等其他 TTS 引擎。但 Edge TTS 免费且支持多种语言和声音，对大多数人来说完全够用了。常用的中文声音包括 zh-CN-XiaoxiaoNeural（女声）、zh-CN-YunxiNeural（男声）等，完整的 TTS 配置可以参考官方文档：[https://docs.openclaw.ai/tools/tts](https://docs.openclaw.ai/tools/tts)
...
> 相关阅读：
> - 上一章：[[04-第四章 OpenClaw 模型选择与切换]]
> - 下一章：[[06-第六章 OpenClaw Skills 技能系统]]
