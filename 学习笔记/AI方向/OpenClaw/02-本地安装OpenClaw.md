...
实测了多种安装方式，踩了不少坑，下面手把手带你走一遍 Windows 上最稳的安装方式。
...
在网上搜了一大圈解决方案，也没能解决这个问题，期待官方后续修复。但好消息是，**这行命令不执行也几乎不影响正常使用**，直接忽略就行。
...
推荐新手选择 Qwen，因为它支持 OAuth 授权登录，会自动弹出网页让你扫码验证，不用手动去申请和填写 API Key，而且可以直接免费使用。缺点是调用太频繁可能会被限流，所以只适合快速上手体验。
...
> 相关阅读：
> - 上一章：[[01-OpenClaw是什么|01 OpenClaw 是什么]]
> - 下一章：[[03-云端部署OpenClaw|03 云端部署 OpenClaw]]
